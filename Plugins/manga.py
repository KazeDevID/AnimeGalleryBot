...
class Manga():
    ...
    @bot.on(events.NewMessage(pattern=r"^/manga|^/manga@AnimeGallery_ByKazeBot"))
    ...
    async def event_handler_manga(event):
        try:
            ...
            await event.reply("Something went wrong.....\nCheck if you entered command properly\n\nUse /help or go to \n@NothingSupportBot if you have any doubts")
            print(e)
